...
- dashboard: connection_distribution
  ...
  description: ''
  preferred_slug: tdvWDzK2yaSkH3yjABgYjq
  elements:
  - title: By Month
    name: By Month
  ...
  - title: New SC
    ...
    fields: [normalized.date_month, normalized._4g_density, normalized._4g_density_past_month,
      normalized._3g_density, normalized._3g_density_past_month]
