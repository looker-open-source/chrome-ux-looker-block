...
- dashboard: cumulative_layout_shift_cls
  ...
  description: ''
  preferred_slug: 62RpldHGYkT7uStiCgxsBM
  elements:
  - title: By Month
    name: By Month
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_cls_pct, device_summary.good_cls_last_month,
  ...
  - title: NavBar
    ...
    type: looker_grid
    fields: [navigation_bar.nav_bar_active_cls]
    filters: {}
    sorts: [navigation_bar.nav_bar_active_cls]
    limit: 500
    column_limit: 50
    show_view_names: false
