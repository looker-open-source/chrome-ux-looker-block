---
- dashboard: cumulative_layout_shift_cls
  title: Cumulative Layout Shift (CLS)
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: VDhBfzfqrRwI05nkFuty52
  elements:
  - title: By Month
    name: By Month
    ...
    filters:
      ...
      device_summary.dynamic_metric: cls
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_cls_pct, device_summary.avg_good_cls_last_month,
      device_summary.avg_p75_cls, device_summary.avg_p75_cls_last_month, device_summary.avg_poor_cls_pct,
      device_summary.avg_poor_cls_last_month]
