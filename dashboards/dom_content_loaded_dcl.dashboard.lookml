...
- dashboard: dom_content_loaded_dcl
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_dcl_pct, device_summary.avg_good_dcl_last_month,
    ...
    show_comparison_device_summary.avg_good_dcl_last_month: true
    comparison_style_device_summary.avg_good_dcl_last_month: percentage_change
    comparison_show_label_device_summary.avg_good_dcl_last_month: false
    pos_is_bad_device_summary.avg_good_dcl_last_month: false
    style_device_summary.avg_p75_dcl: "#FC9200"
    title_override_device_summary.avg_p75_dcl: P75 DCL (All Devices)
    title_placement_device_summary.avg_p75_dcl: above
    show_comparison_device_summary.avg_p75_dcl_last_month: true
    comparison_style_device_summary.avg_p75_dcl_last_month: percentage_change
    comparison_show_label_device_summary.avg_p75_dcl_last_month: false
    pos_is_bad_device_summary.avg_p75_dcl_last_month: true
    title_override_device_summary.avg_poor_dcl_pct: Poor DCL
    title_placement_device_summary.avg_poor_dcl_pct: above
    show_comparison_device_summary.avg_poor_dcl_last_month: true
    comparison_style_device_summary.avg_poor_dcl_last_month: percentage_change
    comparison_show_label_device_summary.avg_poor_dcl_last_month: false
    pos_is_bad_device_summary.avg_poor_dcl_last_month: true
    comparison_label_placement_device_summary.avg_poor_dcl_last_month: below
    comp_value_format_device_summary.avg_poor_dcl_last_month: ''
    comparison_label_placement_device_summary.avg_p75_dcl_last_month: below
    comp_value_format_device_summary.avg_p75_dcl_last_month: ''
    comparison_label_placement_device_summary.avg_good_dcl_last_month: below
    comp_value_format_device_summary.avg_good_dcl_last_month: ''
  ...
  - title: ___
    ...
    explore: device_summary
    type: single_value
    fields: [device_summary.nav_bar_dcl]
    filters: {}
    sorts: [device_summary.nav_bar_dcl]
    limit: 1
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
