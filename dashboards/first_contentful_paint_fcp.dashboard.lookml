...
- dashboard: first_contentful_paint_fcp
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_fcp_pct, device_summary.good_fcp_last_month,
      device_summary.avg_p75_fcp, device_summary.p75_fcp_last_month, device_summary.avg_poor_fcp_pct,
      device_summary.poor_fcp_last_month]
