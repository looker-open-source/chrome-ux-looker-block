---
- dashboard: first_contentful_paint_fcp
  title: First Contentful Paint (FCP)
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: xzd9q4zvRzvjaXDGKmysST
  elements:
  - title: By Month
    name: By Month
    ...
    filters:
      device_summary.dynamic_metric: fcp
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_fcp_pct, device_summary.avg_good_fcp_last_month,
      device_summary.avg_p75_fcp, device_summary.avg_p75_fcp_last_month, device_summary.avg_poor_fcp_pct,
      device_summary.avg_poor_fcp_last_month]
    ...
    dividers: false
    style_device_summary.avg_good_fcp_pct: "#3A4245"
    show_title_device_summary.avg_good_fcp_pct: true
    value_format_device_summary.avg_good_fcp_pct: ''
    show_title_device_summary.avg_p75_fcp: true
    value_format_device_summary.avg_p75_fcp: ''
    show_comparison_device_summary.avg_p75_fcp: false
    title_hidden: true
    listen:
      Device Type: device_summary.device
      Origin: device_summary.origin
  ...
  - title: ___
    ...
    explore: device_summary
    type: single_value
    fields: [device_summary.nav_bar_fcp]
    filters: {}
    sorts: [device_summary.nav_bar_fcp]
    limit: 1
    column_limit: 50
    custom_color_enabled: true
    show_single_value_title: true
