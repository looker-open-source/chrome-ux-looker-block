...
- dashboard: first_paint_fp
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_fp_pct, device_summary.good_fp_last_month,
      device_summary.avg_p75_fp, device_summary.p75_fp_last_month, device_summary.avg_poor_fp_pct,
      device_summary.poor_fp_last_month]
    ...
    show_comparison_device_summary.good_fp_last_month: true
    comparison_style_device_summary.good_fp_last_month: percentage_change
    comparison_show_label_device_summary.good_fp_last_month: false
    pos_is_bad_device_summary.good_fp_last_month: false
    style_device_summary.avg_p75_fp: "#3A4245"
    show_title_device_summary.avg_p75_fp: true
    title_override_device_summary.avg_p75_fp: P75 FP
    ...
    show_comparison_device_summary.p75_fp_last_month: true
    comparison_style_device_summary.p75_fp_last_month: percentage_change
    comparison_show_label_device_summary.p75_fp_last_month: false
    pos_is_bad_device_summary.p75_fp_last_month: true
    style_device_summary.avg_poor_fp_pct: "#3A4245"
    show_title_device_summary.avg_poor_fp_pct: true
    title_override_device_summary.avg_poor_fp_pct: Poor FP
    title_placement_device_summary.avg_poor_fp_pct: above
    value_format_device_summary.avg_poor_fp_pct: ''
    show_comparison_device_summary.avg_poor_fp_pct: false
    show_comparison_device_summary.poor_fp_last_month: true
    comparison_style_device_summary.poor_fp_last_month: percentage_change
    comparison_show_label_device_summary.poor_fp_last_month: false
    pos_is_bad_device_summary.poor_fp_last_month: true
    comparison_label_placement_device_summary.poor_fp_last_month: below
    comp_value_format_device_summary.poor_fp_last_month: ''
    style_device_summary.poor_fp_last_month: "#3A4245"
    show_title_device_summary.poor_fp_last_month: true
    title_placement_device_summary.poor_fp_last_month: above
    value_format_device_summary.poor_fp_last_month: ''
    comparison_label_placement_device_summary.p75_fp_last_month: below
    comp_value_format_device_summary.p75_fp_last_month: ''
    style_device_summary.p75_fp_last_month: "#3A4245"
    show_title_device_summary.p75_fp_last_month: true
    title_placement_device_summary.p75_fp_last_month: above
    value_format_device_summary.p75_fp_last_month: ''
    comparison_label_placement_device_summary.good_fp_last_month: below
    comp_value_format_device_summary.good_fp_last_month: ''
    style_device_summary.good_fp_last_month: "#3A4245"
    show_title_device_summary.good_fp_last_month: true
    title_placement_device_summary.good_fp_last_month: above
    value_format_device_summary.good_fp_last_month: ''
