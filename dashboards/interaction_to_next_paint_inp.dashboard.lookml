...
- dashboard: interaction_to_next_paint_inp
  ...
  description: ''
  preferred_slug: 0KUf7bNKDjpot9x55YSMmQ
  elements:
  - title: By Month
    name: By Month
  ...
  - title: Socrecardss
    ...
    dividers: false
    style_device_summary.avg_good_inp_pct: "#3A4245"
    show_title_device_summary.avg_good_inp_pct: true
    ...
    style_device_summary.avg_p75_inp: "#3A4245"
  ...
  - title: NavBar
    ...
    type: looker_grid
    fields: [navigation_bar.nav_bar_active_inp]
    filters: {}
    sorts: [navigation_bar.nav_bar_active_inp]
    limit: 500
    column_limit: 50
    show_view_names: false
