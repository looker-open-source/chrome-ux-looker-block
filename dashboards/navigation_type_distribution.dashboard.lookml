...
- dashboard: navigation_type_distribution
  ...
  description: ''
  preferred_slug: dET21Z5XOdCRU4W85tTttE
  elements:
  - title: By Month
    name: By Month
  ...
  - title: New SC
    ...
    fields: [normalized.date_month, normalized.navigate_proportion, normalized.navigate_proportion_past_month,
      normalized.back_forward_cache_proportion, normalized.back_forward_cache_proportion_past_month,
      normalized.prerender_proportion, normalized.prerender_proportion_past_month]
