...
- dashboard: navigation_type_distribution
  ...
  - title: ___
    ...
    explore: device_summary
    type: single_value
    fields: [device_summary.nav_bar_navigation_type_distrbution]
    filters: {}
    sorts: [device_summary.nav_bar_navigation_type_distrbution]
    limit: 1
    column_limit: 50
  ...
  - title: Scorecardsss
    ...
    style_device_summary.total_back_forward_nav_proportion: "#E8710A"
