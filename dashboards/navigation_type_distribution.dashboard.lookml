---
- dashboard: navigation_type_distribution
  title: Navigation Type Distribution
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: ooTaAKlPoEzII1MheqTm9S
  elements:
  - title: By Month
    name: By Month
    ...
    fields: [device_summary.date_month, device_summary.date_month_name, device_summary.date_year,
      device_summary.total_navigate_nav_proportion, device_summary.total_navigate_cache_nav_proportion,
      device_summary.total_reload_nav_proportion, device_summary.total_restore_nav_proportion,
      device_summary.total_back_forward_nav_proportion, device_summary.total_back_forward_cache_nav_proportion,
      device_summary.total_prerender_nav_proportion]
    ...
    series_colors:
      ...
      device_summary.total_navigate_nav_proportion: "#FC9200"
      device_summary.total_navigate_cache_nav_proportion: "#2B99F7"
      device_summary.total_reload_nav_proportion: "#08B248"
      device_summary.total_back_forward_nav_proportion: "#FC2E31"
      device_summary.total_restore_nav_proportion: "#A918B4"
      device_summary.total_back_forward_cache_nav_proportion: "#24BED5"
      device_summary.total_prerender_nav_proportion: "#FC9200"
    series_labels:
      ...
      device_summary.total_navigate_nav_proportion: Navigate
      device_summary.total_navigate_cache_nav_proportion: Cached
      device_summary.total_reload_nav_proportion: Reload
      device_summary.total_restore_nav_proportion: Restore
      device_summary.total_back_forward_nav_proportion: Back/Forward
      device_summary.total_back_forward_cache_nav_proportion: BFCache
      device_summary.total_prerender_nav_proportion: Prerender
    label_color: []
  ...
  - title: Scorecardsss
    ...
    fields: [device_summary.date_pop_month, device_summary.total_navigate_cache_nav_proportion,
      device_summary.cache_last_month, device_summary.total_back_forward_nav_proportion,
      device_summary.back_forward_last_month, device_summary.total_prerender_nav_proportion,
      device_summary.prerender_last_month]
    ...
    dividers: false
    style_device_summary.total_navigate_cache_nav_proportion: "#3A4245"
    show_title_device_summary.total_navigate_cache_nav_proportion: true
    title_override_device_summary.total_navigate_cache_nav_proportion: Cached
    title_placement_device_summary.total_navigate_cache_nav_proportion: above
    value_format_device_summary.total_navigate_cache_nav_proportion: ''
    show_comparison_device_summary.cache_last_month: true
    comparison_style_device_summary.cache_last_month: percentage_change
    comparison_show_label_device_summary.cache_last_month: false
    pos_is_bad_device_summary.cache_last_month: false
    style_device_summary.total_back_forward_nav_proportion: "#3A4245"
    show_title_device_summary.total_back_forward_nav_proportion: true
    title_override_device_summary.total_back_forward_nav_proportion: B/F Cache
    title_placement_device_summary.total_back_forward_nav_proportion: above
    value_format_device_summary.total_back_forward_nav_proportion: ''
    show_comparison_device_summary.total_back_forward_nav_proportion: false
    show_comparison_device_summary.back_forward_last_month: true
    comparison_style_device_summary.back_forward_last_month: percentage_change
    comparison_show_label_device_summary.back_forward_last_month: false
    pos_is_bad_device_summary.back_forward_last_month: false
    style_device_summary.total_prerender_nav_proportion: "#3A4245"
    show_title_device_summary.total_prerender_nav_proportion: true
    title_override_device_summary.total_prerender_nav_proportion: Prerender
    title_placement_device_summary.total_prerender_nav_proportion: above
    value_format_device_summary.total_prerender_nav_proportion: ''
    show_comparison_device_summary.total_prerender_nav_proportion: false
    show_comparison_device_summary.prerender_last_month: true
    comparison_style_device_summary.prerender_last_month: percentage_change
    comparison_show_label_device_summary.prerender_last_month: false
    pos_is_bad_device_summary.prerender_last_month: false
    comparison_label_placement_device_summary.prerender_last_month: below
    comp_value_format_device_summary.prerender_last_month: ''
    comparison_label_placement_device_summary.back_forward_last_month: below
    comp_value_format_device_summary.back_forward_last_month: ''
    comparison_label_placement_device_summary.cache_last_month: below
    comp_value_format_device_summary.cache_last_month: ''
    ...
    style_device_summary.total_back_forward_cache_nav_proportion: "#3A4245"
    show_title_device_summary.total_back_forward_cache_nav_proportion: true
    title_placement_device_summary.total_back_forward_cache_nav_proportion: above
    value_format_device_summary.total_back_forward_cache_nav_proportion: ''
    show_comparison_device_summary.total_back_forward_cache_nav_proportion: false
    title_hidden: true
    listen:
      Origin: device_summary.origin
      Device Type: device_summary.device
  ...
  - title: NavBar
    ...
    explore: device_summary
    type: looker_grid
    fields: [device_summary.nav_bar_active_navigation_type_distribution]
    filters: {}
    sorts: [device_summary.nav_bar_active_navigation_type_distribution]
    limit: 500
    column_limit: 50
    show_view_names: false
