...
- dashboard: summary
  ...
  description: ''
  preferred_slug: Mv1hsVXCMy784qMMh5OfW4
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: Month
    ...
    comparison_style_device_summary.date_month: value
    comparison_show_label_device_summary.date_month: false
    comparison_label_placement_device_summary.date_month: below
    comp_value_format_device_summary.date_month: ''
