...
- dashboard: time_to_first_byte_ttfb
  ...
  - title: Scorecardss
    ...
    fields: [device_summary.date_pop_month, device_summary.avg_good_ttfb_pct, device_summary.good_ttfb_last_month,
      device_summary.avg_p75_ttfb, device_summary.p75_ttfb_last_month, device_summary.avg_poor_ttfb_pct,
      device_summary.poor_ttfb_last_month]
