view: country_normalized {
  derived_table: {
    sql:
      ...
      FROM `@{CRUX_PUBLIC_PROJECT_ID}.@{CRUX_DATASET}.country_summary` AS device_summary
      WHERE
...
#--- Dynamic Performance Metrics -------------------------------------------------------------
  ...
  # https://looker-marketplace-dev.cloud-bi-opm.com/explore/chrome-ux-block/country_normalized?fields=country_normalized.country_code,country_normalized.dynamic_good_pct,country_normalized.dynamic_ni_pct,country_normalized.dynamic_poor_pct&f[country_normalized.date_month]={{ value }}&f[country_normalized.device_filter]={{ _filters['normalized.device_filter'] }}&f[country_normalized.origin_filter]={{ _filters['normalized.origin_filter'] }}&f[country_normalized.dynamic_good_pct]=NOT+NULL&f[country_normalized.dynamic_metric]={{ _filters['normalized.dynamic_metric'] }}&sorts=country_normalized.dynamic_good_pct+desc&limit=10&column_limit=50
